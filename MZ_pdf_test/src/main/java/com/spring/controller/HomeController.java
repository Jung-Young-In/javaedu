...
public class HomeController {
	...
	public void pdf(HttpServletResponse response) throws Exception {
		...
		//배경이미지 로드
		PDImageXObject pdImage = PDImageXObject.createFromFile(webroot + "resources/approval.jpg", doc);
...
//		PDType0Font fontGulim = PDType0Font.load(doc, fontStream);
		...
		for (int i = 0; i < pageCount; i++) {
			...
			//글씨 쓰기
			drawText("PDF BOX 라이브러리를 사용하여", fontGulim, 18, 100, 600, contentStream);
			drawText("PDF 만들기", fontGulim, 18, 100, 560, contentStream);
		...
		String fileName = URLEncoder.encode("샘플 PDF", "UTF-8");
