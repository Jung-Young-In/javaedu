    ...
    <section class="content">		
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-outline-info" id="registBtn" onclick="OpenWindow('registForm.do','공지등록',800,700);">문의글 등록</button>				
				<div id="keyword" class="card-tools" style="width:450px;">
					<div class="input-group row">
						...
						<span class="input-group-append">
							<button class="btn btn-outline-info" type="button" onclick="list_go(1);" 
				...
				<table class="table table-striped text-center" >					
					...
					<c:forEach items="${boardList }" var="board">
						<tr style='font-size:0.85em;'>
							...
							<td><span class="badge bg-yellow">${board.viewcnt }</span></td>
						</tr>
					</c:forEach>
				</table>				
			</div>
