				...
				<div class="card card-outline card-info">
					<div class="card-header">
						...
						<div class="card-tools">
							<button type="button" onclick="modify_go();" id="modifyBtn" class="btn btn-warning">MODIFY</button>						
						    <button type="button" onclick="remove_go();" id="removeBtn" class="btn btn-danger">REMOVE</button>
						    <button type="button" onclick="CloseWindow();" id="listBtn" class="btn btn-primary">CLOSE</button>
					    </div>
					</div>
					<div class="card-body">
