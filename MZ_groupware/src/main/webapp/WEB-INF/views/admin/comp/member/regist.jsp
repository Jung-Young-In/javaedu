			...
			<div class="card card-custom gutter-b example example-compact">
				<div class="card-header flex-wrap border-0 pt-6 pb-0">
					...
					<div class="card-toolbar">
						<button class="btn btn-sm btn-light font-weight-bolder mr-2" id="btnOp" onclick="fn_operate();">AUTO</button>
						<button class="btn btn-light-primary font-weight-bolder mr-2" onclick="regist_go();">등록</button>
						...
						<div class="col-3" style="text-align: center;">
							<div class="image-input image-input-outline">
								...
								<div class="row" style="margin-top: 10px;">
									<div class="image-input-wrapper" id="pictureView" style="width:150px; height:200px;"></div>
									<label for="inputFile" style="position: relative;right: 0px;top: 5px;" class="btn btn-light-primary btn-sm btn-append btn-block font-weight-bolder" data-action="change" data-toggle="tooltip" data-original-title="사진추가" >
									사진 추가
									</label>
<!-- 									<button type="button" class="btn btn-light-primary btn-sm btn-append btn-block font-weight-bolder" onclick="picture_go();">업로드</button>  -->
								</div>
...
<!-- 								</div> -->
						...
						<div class="col-9">
							...
							<input type="hidden" name="empPhoto" id="empPhoto"/>
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empNo" id="empNo" 
	                         type="text" class="form-control" placeholder="사번을 발급받으세요."
	                         maxlength=10 readonly>
	                  <span class="input-group-append-sm">   
	                  <button type="button" onclick="getEmpNo();"  class="btn btn-primary btn-sm btn-append">사번발급</button>
	                  </span>                        
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empHp" id="empHp" type="text" class="form-control" placeholder="이름을 입력해주세요"
	                	       maxlength=15>
	                  <span class="input-group-append-sm">   
	                  </span>                        
	                </div><!-- col-sm-9 input-group input-group-sm -->
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empEmail" id="empEmail" type="text" class="form-control" placeholder="이메일을 입력해주세요."
	                		   maxlength=30>
	                  <span class="input-group-append-sm">   
	                  </span>                        
	                </div><!-- col-sm-9 input-group input-group-sm -->
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empRegno" id="empRegno" type="text" class="form-control"  
	                	       placeholder="주민번호를 입력해주세요" maxlength=20>
	                  <span class="input-group-append-sm">   
	                  </span>                        
	                </div><!-- col-sm-9 input-group input-group-sm -->
	              </div><!-- form-group row -->
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empZipcode" id="empZipcode" type="text" class="form-control" placeholder="우편번호를 검색하세요."
	                	       maxlength=10 readonly="readonly">
	                  <span class="input-group-append-sm">  
	                  <button type="button" onclick="sample6_execDaumPostcode();"  class="btn btn-primary btn-sm btn-append">우편번호 찾기</button> 
	                  </span>
	                </div><!-- col-sm-9 input-group input-group-sm -->
	              </div><!-- form-group row -->
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empAddr1" id="empAddr1" type="text" class="form-control" placeholder="도,시 "
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empAddr2" id="empAddr2" type="text" class="form-control" placeholder="상세주소를 입력하세요."
	                	       maxlength=150>
	                  <span class="input-group-append-sm">   
	                  </span>                        
	                </div><!-- col-sm-9 input-group input-group-sm -->
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<select class="form-control form-control-sm" name="deptCode" id="selectDeptName">
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<select class="form-control form-control-sm" name="psCode" id="selectPsName">
							<option value="0" selected>--선택하세요--</option>
							<c:forEach items="${positionList}" var="positionList">
								<option value="${positionList.psCode}">${positionList.psName}</option>
							</c:forEach>
						</select>
	                  <span class="input-group-append-sm">   
	                  </span>                        
	              ...
	              <div class="form-group row">
									<label for="kt_datepicker_4_1" class="col-sm-3" style="font-size:0.9em; text-align: right;" >
	              	<span style="color:red;font-weight:bold;">*</span>입사일</label>   
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input type="text" class="form-control" name="empCreateDate" id="kt_datepicker_4_1" readonly="readonly" placeholder="입사일 입력">
	                  <span class="input-group-append-sm">   
	                  </span>                        
	                </div><!-- col-sm-9 input-group input-group-sm -->
	              </div><!-- form-group row -->
	              ...
	              <div class="form-group row">
	              	...
	              	<div class="col-sm-9 input-group input-group-sm">
	                	<input name="empTel" id="empTel" type="text" class="form-control" placeholder="이름을 입력해주세요"
	                	       maxlength=15>
	                  <span class="input-group-append-sm">   
	                  </span>                        
	                </div><!-- col-sm-9 input-group input-group-sm -->
...
<form role="imageForm" action="admin/comp/member/promotion/modify.do" method="post" enctype="multipart/form-data"><!-- 화면이 새로고침되게이 submit은 불가능 -->
...
function fn_operate(){
	$('#btnOp').hide();
	$("input[name='empName']").val('변형균');
	$("input[name='empHp']").val('010-7568-9348');
	$("input[name='empEmail']").val('princeByun@gmail.com');
	$("input[name='empRegno']").val('940428-1000000');
	$("input[name='empZipcode']").val('35054');
	$("input[name='empAddr1']").val('대전 대흥동 영민빌딩');
	$("input[name='empAddr2']").val('대덕인재개발원 403호');
	$("input[name='empTel']").val('070-7568-9348');
}
// 사진 업로드 --------------------------------------------------------------------
/**
...
//	alert("regist_go");
  ...
  val = $("#empHp").val();
	...
	if(checkRegExp(empHp, val)){ // 정규식 체크(길이, 공백, 올바른 입력)
		alert("010 또는 011로 시작하는 휴대폰 번호만 사용하세요. (예: 010-1234-0000)");
		$('input[name="empHp"]').focus();
    return;
  }
