														...
														<div class="align-items-center" id="${notification.notificationNo }">
															<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
																<div class="d-flex flex-column font-weight-bold">
																	<a href="javascript:goPage('${notification.notificationUrl }', 'Q020000'); javascript:removeNotify('${notification.notificationNo }');" class="font-weight-bold text-dark-75 text-hover-primary">
																		[${notification.notificationType }] ${notification.notificationContent }
																	</a>
																</div>
																<div align="left">
																	<a href="javascript:removeNotify('${notification.notificationNo }');" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_cart_close">
