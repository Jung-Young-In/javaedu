...
<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
	...
	<li class="nav-item mb-2" data-toggle="tooltip" title="" data-placement="left" data-original-title="쪽지함">
		<button class="btn btn-sm btn-icon btn-bg-light btn-icon-warning btn-hover-warning" onclick="javascript:OpenWindow('<%=request.getContextPath()%>/message/receive/list.do','쪽지함',1200,700);" >
