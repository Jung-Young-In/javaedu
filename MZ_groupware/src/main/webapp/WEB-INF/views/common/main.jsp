												...
												<c:choose>
													<c:when test="${!empty msgRecMap.msgList}">
														<c:forEach items="${msgRecMap.msgList }" var="msg" end="3">
															<tr onclick="OpenWindow('<%=request.getContextPath()%>/message/main/detail.do?mssNo=${msg.mssNo}','쪽지 상세',600,500);">
																...
																<c:set var="senddate2" value="${fn:substring(tmp,3, 8)}"/>
												...
												<c:choose>
													<c:when test="${!empty msgSendMap.msgList}">
														<c:forEach items="${msgSendMap.msgList }" var="msg" end="3">
															<tr onclick="OpenWindow('<%=request.getContextPath()%>/message/main/detail.do?mssNo=${msg.mssNo}','쪽지 상세',500,450);">
																<td class="align-middle d-inline-block text-truncate py-2" width="220px">${msg.mssContent}</td>
