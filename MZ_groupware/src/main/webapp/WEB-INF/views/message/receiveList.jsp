...
#chacha::-webkit-scrollbar {
	width: 5px; /*스크롤바의 너비*/
}

#chacha::-webkit-scrollbar-thumb {
	background-color: #3699FF;
}

#chacha::-webkit-scrollbar-track {
					...
					<div class="card-toolbar">
						<ul class="nav nav-tabs nav-bold nav-tabs-line">
							<li class="nav-item" onclick="parent.goPage('message/receive/list.do','Q020000');">
								<a class="nav-link active" data-toggle="tab" href="#" id="recbox">
							...
							<li class="nav-item" onclick="parent.goPage('message/send/list.do','Q020000');">
								<a class="nav-link" data-toggle="tab" href="#" id="sendbox">
				...
				<div class="card-body">
					<div class="form-inline">
						<div class="table-responsive" id="receiveTable">
							<table class="table table-hover cursor-pointer" style="font-size: 12.5px;">
								<thead>
									<tr>
										<th scope="col" class="text-center" style="width: 70px;">NO</th>
										<th scope="col" class="text-center">쪽지 내용</th>
										<th scope="col" class="text-center" style="width: 70px;">발신자</th>
								...
								<tbody>
									<c:choose>
										<c:when test="${!empty dataMap.msgList}">
											<c:forEach items="${dataMap.msgList }" var="msg" varStatus="i">
												<tr onclick="javascript:detail_go(${msg.mssNo});">
													<th scope="row" class="text-center text-dark">${pageMaker.totalCount - (cri.perPageNum * (cri.page - 1)) - i.index }</th>
													<td class="text-left">
														<div class="ellipsis">${msg.mssContent}</div>
													</td>
													<td class="text-center" style="width: 70px;">${msg.sender}</td>
            ...
            <div class="modal-content" style="height: 700px; width: 800px;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8" id="chacha" style="border: 1px solid #EBEDF3; height:330px; overflow:auto;">
...
function detail_go(mssNo) {
	...
	$.ajax({
		...
		contentType : "application/json",
		success : function(data) {
			$("#receiveTable").load("<%=request.getContextPath()%>/message/receive/list.do" + " #receiveTable");
