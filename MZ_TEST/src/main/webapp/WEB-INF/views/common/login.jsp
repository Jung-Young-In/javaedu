...
<html>
                  ...
                  <div class="login-signin">
                     <form class="form" action="<%=request.getContextPath() %>/common/login.do" method="post">
                        <div class="form-group mb-3">
                           <input class="form-control h-auto form-control-solid py-4 px-5" type="text" placeholder="Employee number" name="empNo" autocomplete="off" />
                        </div>
                        <div class="form-group mb-3">
                           <input class="form-control h-auto form-control-solid py-4 px-5" type="password" placeholder="Password" name="empPwd" />
                        </div>
                        ...
                        <button type="button" class="btn btn-secondary font-weight-bold px-9 py-4 my-3 mx-4" onclick="qr_go();">QR Sign In</button>
                        <button type="submit" class="btn btn-warning font-weight-bold px-9 py-4 my-3 mx-4">Sign In</button>
                     </form>
                     <div class="mt-10">
   ...
   <script type="text/javascript">
   		function qr_go() {
   			loaction.href = "<%=request.getContextPath()%>/common/qrLogin.do";
   		}
   </script>
</html>