											...
											<li class="attach-item">																			
												<div class="mailbox-attachment-info">
													<a class="mailbox-attachment-name" name="attachedFile" 
														...
														href="<%=request.getContextPath()%>/pds/getFile.do?pno=${pds.pno }&ano=${attach.ano }"  >													
...
window.onload=function(){
	...
	$('a[name="attachedFile"] > button').click(function(event){
		...
		$('form[role="form"]').prepend(input);	//prepend는 위에서 붙이는 것, append는 아래에서 붙이는것(위 과정 순서 중요!)
		return false;
	});
